...
function Sidebar() {
  ...
  return (
    <aside
      ...
      className={`relative w-64 z-40 h-screen transition-all -translate-x-full translate-x-0 ${
        // className={`absolute right-0 z-40 h-screen transition-all -translate-x-full translate-x-0 ${
        ...
        <ul className="space-y-2 font-medium">
          <li>
            ...
            >
              ...
              <span className="ml-3">ڈیش بورڈ</span>
            </a>
          </li>
          <li>
            <button
          ...
          <li>
            ...
            >
              ...
              <span className="ml-3 flex-1 whitespace-nowrap">کنبان</span>
